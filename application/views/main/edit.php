    ...
    <div class="popup_create_new">
        <form action="/edit/<?= $this->route['id'] ?>" method="POST" enctype="multipart/form-data"  >
            ...
            <div class="popup_inputs_container">
                ...
                <input type="text" placeholder="first name" name="new_first_name" value="<?= $author[0]['first_name'] ?>" readonly>
                <input type="text" placeholder="last name" name="new_last_name" value="<?= $author[0]['last_name'] ?>" readonly>
